...
## 编译固件
1. 预编译的固件(预编译的固件源码版本是 [Commits on Dec 8, 2022](https://github.com/Klipper3d/klipper/commit/336cc92a0a06a78358d1c17c7c620655a6eaa055))
   * [firmware-USB.bin](./firmware-USB.bin) 使用 USB 与树莓派通信。M4P 上的 MCU 的 USB 在板上与 CB1/CM4 已经连接好了，更新完固件即可使用，不需要额外的接线。
...
2. 参考 [klipper官方的安装说明](https://www.klipper3d.org/Installation.html) to `Configuring Klipper`. 并且使用我们提供的配置文件 [generic-bigtreetech-manta-m4p.cfg](./generic-bigtreetech-manta-m4p.cfg) 为基础去修改 `printer.cfg`, 此文件中包含了主板几乎所有的pinout
