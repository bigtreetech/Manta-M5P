...
1. Precompiled firmware(The source code version used is [Commits on Dec 8, 2022](https://github.com/Klipper3d/klipper/commit/336cc92a0a06a78358d1c17c7c620655a6eaa055))
...
2. Refer to [klipper's official installation](https://www.klipper3d.org/Installation.html) to `Configuring Klipper`. And use the configuration file [generic-bigtreetech-manta-m4p.cfg](./generic-bigtreetech-manta-m4p.cfg) as the underlying `printer.cfg`, which includes all the correct pinout for Octopus
